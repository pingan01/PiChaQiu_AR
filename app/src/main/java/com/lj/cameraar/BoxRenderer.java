...
public class BoxRenderer {
    ...
    public void init(List<ObjFilter2> filters) {
        Log.e("TAG", "init()");
    ...
    public void render(List<ObjFilter2> filters) {
        Log.e("TAG", "render()");
        pikaqiu(filters);
        //demoRender(projectionMatrix,cameraview,size);
    }
     ...
     * @param size
     */
    private void demoRender(Matrix44F projectionMatrix, Matrix44F cameraview, Vec2F size) {
     ...
     * @param filters
     */
    private void pikaqiu(List<ObjFilter2> filters) {
        for (ObjFilter2 f : filters) {
